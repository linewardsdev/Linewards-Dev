...
This reference guides visual design, art direction, and graphics implementation for **Line Wards**, a mobile-first competitive tower-wars game inspired by the Warcraft III custom-map tradition of Line Tower Wars.
