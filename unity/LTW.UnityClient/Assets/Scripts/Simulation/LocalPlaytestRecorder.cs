...
namespace LTW.UnityClient.Simulation
{
    public sealed class LocalPlaytestRecorder : MonoBehaviour
    {
        ...
        private int? firstSendTick;
        private int? firstLeakTick;
        private int? firstEliminationTick;
        ...
        private static string FormatTick(int? tick) => tick.HasValue ? tick.Value.ToString() : "not observed";
    }
}
