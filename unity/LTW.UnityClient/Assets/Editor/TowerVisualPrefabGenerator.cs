...
namespace LTW.UnityClient.Editor
{
    ...
    {
        private const string MenuPath = "Line Wars/Art/Generate Placeholder Tower Prefabs";
        private const string ValidateMenuPath = "Line Wars/Art/Validate Tower Placeholder Prefabs";
        private const string GenerateAuthoredArrowMenuPath = "Line Wars/Art/Generate Authored Arrow Tower";
        private const string GenerateWardPrototypeMenuPath = "Line Wars/Art/Generate Ward Prototype Tower Wrappers";
...
This report is generated by `Line Wars > Art > Generate Placeholder Tower Prefabs`.
...
1. Run `Line Wars > Art > Validate Tower Placeholder Prefabs`.
...
This report is generated by `Line Wars > Art > Generate Ward Prototype Tower Wrappers`.
...
- Source-kit prefabs are nested as visual children; runtime profiles still point to Line Wars wrapper prefabs.
