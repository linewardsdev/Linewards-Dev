...
public sealed class LocalMatchOptions
{
    ...
    public LocalMatchOptions(
        ...
        BotDecisionProfile player5Profile = BotDecisionProfile.Greedy,
        BotDecisionProfile player6Profile = BotDecisionProfile.Greedy,
        BotDecisionProfile player7Profile = BotDecisionProfile.Greedy,
        BotDecisionProfile player8Profile = BotDecisionProfile.Greedy,
