...
| Creep | Shade | `creep.shade` | `Assets/Prefabs/Creeps/Creep_Shade_AIPlate.prefab` | `Assets/Art/Creeps/Production/Sprites/creep_shade_candidate_v02_trimmed.png` | Implemented |
...
- Shade was corrected after review from v01 to v02 because the first production sprite read as a diagonal projectile/VFX burst rather than a compact lane creep.
