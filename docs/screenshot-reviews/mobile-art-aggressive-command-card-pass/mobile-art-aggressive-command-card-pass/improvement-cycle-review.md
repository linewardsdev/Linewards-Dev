...
- Captures passed: `48/48`
- Grayscale copies present: `48/48`
...
| Spawn, route, and leak-gate clarity | 2/3 | /3 | [default-hud](after/phone-standard-portrait/01-default-hud.png), [results-or-late-match](after/phone-standard-portrait/12-results-or-late-match.png) | Canonical evidence exists; assign the final visual score during review. |
...
- 12 canonical visual states captured for every selected profile.
